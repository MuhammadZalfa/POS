...
<aside class="w-64 bg-gradient-to-b from-orange-800 to-orange-900 text-white flex-shrink-0 rounded-r-2xl shadow-2xl flex flex-col">
    ...
    <nav class="flex-1 px-3 py-6 space-y-1.5">
        <a href="{{ url('/dashboard') }}" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group {{ request()->is('dashboard') ? 'bg-orange-700/80 text-white shadow-lg ring-1 ring-orange-500/50' : 'hover:bg-orange-700/40 text-orange-100' }}">
        ...
        <a href="{{ route('admin.products') }}" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group {{ request()->is('products*') ? 'bg-orange-700/80 text-white shadow-lg ring-1 ring-orange-500/50' : 'hover:bg-orange-700/40 text-orange-100' }}">
            <div class="w-8 flex justify-center">
        ...
        <a href="{{ route('admin.inventory') }}" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group {{ request()->is('inventory*') ? 'bg-orange-700/80 text-white shadow-lg ring-1 ring-orange-500/50' : 'hover:bg-orange-700/40 text-orange-100' }}">
            <div class="w-8 flex justify-center">
        ...
        <a href="{{ route('admin.laporan') }}" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group {{ request()->is('laporan*') ? 'bg-orange-700/80 text-white shadow-lg ring-1 ring-orange-500/50' : 'hover:bg-orange-700/40 text-orange-100' }}">
            <div class="w-8 flex justify-center">
